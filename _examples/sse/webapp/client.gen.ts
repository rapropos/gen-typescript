...
// --
// Code generated by Webrpc-gen@v0.34.0-2-g309de97 with ../../ generator. DO NOT EDIT.
//
...
export interface ChatClient {
  ...
  subscribeUsers(options: WebrpcStreamOptions<SubscribeUsersResponse>): WebrpcStreamController
}
...
export interface SubscribeUsersRequest {
}

export interface SubscribeUsersResponse {
  username: string
}
...
export class Chat implements ChatClient {
  ...
  subscribeUsers = (options: WebrpcStreamOptions<SubscribeUsersResponse>): WebrpcStreamController => {
    ...
    const _fetch = () => this.fetch(this.url('SubscribeUsers'),
...
export const WebrpcHeaderValue = "webrpc@v0.34.0-2-g309de97;@unknown;webrpc-sse-chat@v1.0.0"
